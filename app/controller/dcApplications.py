...
class DcApplicationApp(DcApp):
    def __init__(self):
        """
        @api {get} /applications 1. Get all applications (GET)
        ...
        """
        @api {post} /applications 2. Get all applications (POST)
        ...
        """
        @api {put} /applications 3. Create or edit a list of entities
        @apiName PutApplications
        @apiGroup Applications
