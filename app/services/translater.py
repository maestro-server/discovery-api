...
from app.services.translate import MapperAWS, MapperOpenStack, MapperDO, MapperSpaces


class TranslateAPI(object):
    able = {'AWS': MapperAWS, 'OpenStack': MapperOpenStack, 'Digital Ocean': MapperDO, 'Spaces (DO)': MapperSpaces}
